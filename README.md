...
<html lang="pt-br">
    ...
    <body>
        ...
        <style>
            ...
            .promo-banner {
                /* Se você mudou a cor, ela entra aqui. Exemplo: Amarelo Neon */
                background: linear-gradient(135deg, #f7ff00 0%, #dbff00 100%);
                ...
                padding: 20px 40px;
                border-radius: 15px;
                box-shadow: 0 10px 30px rgba(0, 0, 0, 0.15); /* Sombra externa para flutuar */
                max-width: 900px;
                margin: 80px auto;
                position: ;
                overflow: hidden;
            ...
            /* O segredo da leitura: Texto em cor escura chapada */
            .promo-content {
                color: #1a1a1a; 
                text-shadow: 0px 1px 2px rgba(255,255,255,0.5); /* Brilho leve por trás da letra escura */
            }
            ...
            /* Destaque máximo no valor */
            .promo-text strong {
                font-weight: 900;
                font-size: 2rem;
                display: block; /* Joga o desconto para a linha de baixo para impacto */
                letter-spacing: -1px;
                color: #000;
            }
            ...
            .promo-button {
                ...
                box-shadow: 0 4px 0px #333; /* Efeito de botão 3D */
            }
            ...
            /* Detalhe visual moderno: uma forma abstrata no fundo */
            .promo-banner::before {
                content: "";
                position: absolute;
                top: -50%;
        ...
        <div class="promo-banner">
            <div class="promo-content">
                <p class="promo-text">
                    OFERTA EXCLUSIVA:
                    <strong>70% DE DESCONTO</strong>
                </p>
            </div>
            <a href="https://wa.me/+558398015278" class="promo-button">RESGATAR CUPOM</a>
        </div>
    </html>
